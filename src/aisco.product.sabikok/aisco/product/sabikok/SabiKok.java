...
public class SabiKok {
    ...
    {  
        Donation donate = DonationFactory.createDonation("aisco.donation.pcreditcard.DonationImpl");
        donate.addDonation();
        donate.getDonation();
    }

    public static void main(String[] args) {
        System.out.println ("Product Sabi Kok");
